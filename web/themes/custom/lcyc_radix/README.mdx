...
lcyc_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of lcyc_radix theme and run the following commands:
`nvm use`
...
`drush en lcyc_radix -y`
`drush config-set system.theme default lcyc_radix -y`
