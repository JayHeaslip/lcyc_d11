...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://lcyc_db:candc997@mysql.lcyc.info:3306/lcyc_drupal_11?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'https://d11.lcyc.info/sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/home/lcyc/d11.lcyc.info/web/sites/default/files/civicrm';
$civicrm_paths['civicrm.private']['path'] = '/home/lcyc/d11.lcyc.info/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://lcyc_db:candc997@mysql.lcyc.info:3306/lcyc_civicrm_d11?new_link=true');
  }
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define('CIVICRM_TEMPLATE_COMPILEDIR', '/home/lcyc/d11.lcyc.info/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', 'cA7rzbiJePOCWiBnLLSvzlg2FmSmq77VPCwJX00');
}
 ...
 */
 if (!defined('CIVICRM_CRED_KEYS') ) {
  define( 'CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:eoBOdaiTmwI8C4_vlogNV5yi6imKSOmYqSAOAc4nMT8');
}

if (!defined('CIVICRM_DEPLOY_ID')) {
  define('_CIVICRM_DEPLOY_ID', 'LTnojUoG5pIPGA');
...
if (!defined('CIVICRM_SIGN_KEYS')) {
  define('_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:8oxDXz4O4fjLGFQTxqXr5fTQsoNu8yH6dqUmmcNvI7FJZi6Wvg');
...
// define('CIVICRM_MAIL_LOG', '/home/lcyc/d11.lcyc.info/web/sites/default/files/civicrm/templates_c/mail.log');
// }
