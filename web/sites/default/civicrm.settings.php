...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://root:password@localhost:3306/lcyc_d11?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://localhost:8000/sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/home/vboxuser/lcyc_d11/web/sites/default/files/civicrm';
$civicrm_paths['civicrm.private']['path'] = '/home/vboxuser/lcyc_d11/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://root:password@localhost/lcyc_d11?new_link=true');
  }
}
...
$civicrm_root = '/home/vboxuser/lcyc_d11/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define('CIVICRM_TEMPLATE_COMPILEDIR', '/home/vboxuser/lcyc_d11/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', 'z81NRyIXxVJi2xhuAt5e7Bz4408amEA1E2ouSECElZw');
}
...
if (!defined('CIVICRM_CRED_KEYS')) {
  define('_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:CzXhRk7xSIWdfTg78AGKKDsvbreoY2hRAJlVpTm4LpdldFB5Q');
...
if (!defined('CIVICRM_DEPLOY_ID')) {
  define('_CIVICRM_DEPLOY_ID', 'fD4UWTv17Ohjdw');
...
if (!defined('CIVICRM_SIGN_KEYS')) {
  define('_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:4WfBWn1OrPtlrSQnNE67MqZ2dsyC29YW3Csz9DwcjDnFMpVMxRQA');
...
// define('CIVICRM_MAIL_LOG', '/home/vboxuser/lcyc_d11/web/sites/default/files/civicrm/templates_c/mail.log');
// }
