...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://lcyc_db:candc997@mysql.lcyc.info/lcyc_drupal_11?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://lcyc_db:candc997@mysql.lcyc.info/lcyc_drupal_11?new_link=true');
  }
}
...
$civicrm_root = '/home/lcyc/d11.lcyc.info/vendor/civicrm/civicrm-core';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define('CIVICRM_TEMPLATE_COMPILEDIR', '/home/lcyc/d11.lcyc.info/vendor/civicrm/civicrm-core/templates');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define('CIVICRM_UF_BASEURL', 'https://d11.lcyc.info');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', 'KAo7I/hvLJVQ2tpU1CXQfA');
}
...
if (!defined('CIVICRM_CRED_KEYS')) {
  define('_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:RANDOM_1');
